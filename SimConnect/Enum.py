...
class SIMCONNECT_RECV_ID(CtypesEnum):
	...
	SIMCONNECT_RECV_ID_OBSERVER_DATA = 27
	SIMCONNECT_RECV_ID_GROUND_INFO = 28
	SIMCONNECT_RECV_ID_SYNCHRONOUS_BLOCK = 29
	SIMCONNECT_RECV_ID_EXTERNAL_SIM_CREATE = 30
	SIMCONNECT_RECV_ID_EXTERNAL_SIM_DESTROY = 31
	SIMCONNECT_RECV_ID_EXTERNAL_SIM_SIMULATE = 32
	SIMCONNECT_RECV_ID_EXTERNAL_SIM_LOCATION_CHANGED = 33
	SIMCONNECT_RECV_ID_EXTERNAL_SIM_EVENT = 34
	SIMCONNECT_RECV_ID_EVENT_WEAPON = 35
	SIMCONNECT_RECV_ID_EVENT_COUNTERMEASURE = 36
	SIMCONNECT_RECV_ID_EVENT_OBJECT_DAMAGED_BY_WEAPON = 37
	SIMCONNECT_RECV_ID_VERSION = 38
	SIMCONNECT_RECV_ID_SCENERY_COMPLEXITY = 39
	SIMCONNECT_RECV_ID_SHADOW_FLAGS = 40
	SIMCONNECT_RECV_ID_TACAN_LIST = 41
	SIMCONNECT_RECV_ID_CAMERA_6DOF = 42
	SIMCONNECT_RECV_ID_CAMERA_FOV = 43
	SIMCONNECT_RECV_ID_CAMERA_SENSOR_MODE = 44
	SIMCONNECT_RECV_ID_CAMERA_WINDOW_POSITION = 45
	SIMCONNECT_RECV_ID_CAMERA_WINDOW_SIZE = 46
	SIMCONNECT_RECV_ID_MISSION_OBJECT_COUNT = 47
	SIMCONNECT_RECV_ID_GOAL = 48
	SIMCONNECT_RECV_ID_MISSION_OBJECTIVE = 49
	SIMCONNECT_RECV_ID_FLIGHT_SEGMENT = 50
	SIMCONNECT_RECV_ID_PARAMETER_RANGE = 51
	SIMCONNECT_RECV_ID_FLIGHT_SEGMENT_READY_FOR_GRADING = 52
...
class SIMCONNECT_MISSION_OBJECT_TYPE(CtypesEnum):
	SIMCONNECT_MISSION_OBJECT_TYPE_GOAL = 0
	SIMCONNECT_MISSION_OBJECT_TYPE_MISSION_OBJECTIVE = 1
	SIMCONNECT_MISSION_OBJECT_TYPE_FLIGHT_SEGMENT = 2
	SIMCONNECT_MISSION_OBJECT_TYPE_LANDING_TRIGGER = 3


class SIMCONNECT_GOAL_STATE(CtypesEnum):
	SIMCONNECT_GOAL_STATE_GOAL_PENDING = 0
	SIMCONNECT_GOAL_STATE_GOAL_COMPLETED = 1
	SIMCONNECT_GOAL_STATE_GOAL_FAILED = 2
...
class SIMCONNECT_RECV_GOAL(SIMCONNECT_RECV):  # when dwID == SIMCONNECT_RECV_ID_GOAL
	_fields_ = [
		("dwRequestID", DWORD),
		("guidInstanceId", DWORD),
		("isOptional", c_bool),
		("dwOrder", DWORD),
		("dwPointValue", DWORD),
