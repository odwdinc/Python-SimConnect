...
class AircraftRequests():
	...
	def __init__(self, _sm, _time=10, _attempts=10):
		...
		self.AircraftFlightModel = self.__AircraftFlightModel(_sm, _time, _attempts)
		self.list.append(self.AircraftFlightModel)
	...
	class __AircraftEngineData(RequestHelper):
		list = {
			...
			"GENERAL_ENG_THROTTLE_MANAGED:index": ["Mode of the managed throttle for the indexed engine", b'GENERAL ENG THROTTLE MANAGED:index', b'Number', 'N'],
	...
	class __AircraftControlsData(RequestHelper):
		list = {
			...
			"ELEVATOR_TRIM_DOWN_LIMIT": ["The maximum elevator trim down value.", b'ELEVATOR TRIM DOWN LIMIT', b'Degrees', 'N'],
			...
			"ELEVATOR_TRIM_UP_LIMIT": ["The maximum elevator trim up value.", b'ELEVATOR TRIM UP LIMIT', b'Degrees', 'N'],
			...
			"FLAPS_HANDLE_INDEX:index": ["Index of current flap position (Index of 1 only)", b'FLAPS HANDLE INDEX', b'Number', 'Y'],
	...
	class __AircraftFlightModel(RequestHelper):
		list = {
			...
			"DESIGN_SPAWN_ALTITUDE_CRUISE": ["Altitude when spawned in cruise", b'DESIGN SPAWN ALTITUDE CRUISE', b'Feet', 'N'],
			"DESIGN_SPAWN_ALTITUDE_DESCENT": ["Altitude when spawned in descent", b'DESIGN SPAWN ALTITUDE DESCENT', b'Feet', 'N'],
			...
			"G_LIMITER_SETTING": ["The setting of the G-limiter", b'G LIMITER SETTING', b'Enum', 'N'],
			...
			"ZERO_LIFT_ALPHA": ["AoA at which the wigns have Zero lift", b'ZERO LIFT ALPHA', b'Radians', 'N'],
		}
